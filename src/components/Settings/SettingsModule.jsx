...
import { User, Palette, Save, Upload, CheckCircle2, Calendar, LogOut, Moon, Sun, Monitor, Smartphone, Sliders, Shield, Zap, Lock, Copy, Loader2, Check, XCircle } from 'lucide-react';
            ...
            <div className="flex flex-col md:flex-row gap-8 flex-1">
                ...
                <div className="w-full md:w-64 flex flex-col gap-2">
                    <button
                        ...
                        className={`text-left px-4 py-3 rounded-xl text-xs font-bold uppercase tracking-wider transition-all flex items-center gap-3 ${activeTab === 'profile' ? 'bg-white/10 text-white' : 'text-neutral-500 hover:bg-white/5'}`}
                    >
                        <User className="w-4 h-4" /> Profile
                    </button>
                    <button
                        onClick={() => setActiveTab('privacy')}
                        className={`text-left px-4 py-3 rounded-xl text-xs font-bold uppercase tracking-wider transition-all flex items-center gap-3 ${activeTab === 'privacy' ? 'bg-white/10 text-white' : 'text-neutral-500 hover:bg-white/5'}`}
                    >
                        <Lock className="w-4 h-4" /> Privacy
                    </button>
                    <button
                        onClick={() => setActiveTab('appearance')}
                        className={`text-left px-4 py-3 rounded-xl text-xs font-bold uppercase tracking-wider transition-all flex items-center gap-3 ${activeTab === 'appearance' ? 'bg-white/10 text-white' : 'text-neutral-500 hover:bg-white/5'}`}
                    >
                        <Palette className="w-4 h-4" /> Appearance
                    </button>
                    <button
                        onClick={() => setActiveTab('integrations')}
                        className={`text-left px-4 py-3 rounded-xl text-xs font-bold uppercase tracking-wider transition-all flex items-center gap-3 ${activeTab === 'integrations' ? 'bg-white/10 text-white' : 'text-neutral-500 hover:bg-white/5'}`}
                    >
                ...
                {/* Content Area */}
                <div className="flex-1 space-y-8 bg-black/20 p-8 rounded-2xl border border-white/5">
                                ...
                                <div className="flex items-start justify-between">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-neutral-500">Sync protocols and tasks with your calendar.</p>
                                        </div>
                                    </div>
                                    {googleUser ? (
                                        <button
                                            onClick={handleDisconnectGoogle}
                                            className="px-4 py-2 border border-red-500/30 text-red-500 hover:bg-red-500/10 rounded-lg text-xs font-bold uppercase tracking-wider transition-all"
                                        >
                                            Disconnect
                                        </button>
                                    ) : (
                                        <button
                                            ...
                                            className="px-4 py-2 bg-blue-600 hover:bg-blue-500 text-white rounded-lg text-xs font-bold uppercase tracking-wider shadow-lg shadow-blue-900/20 transition-all"
                                        >
                                            Connect
                                        </button>
                                    )}
                    ...
                    <div className="flex justify-end pt-4 border-t border-white/5">
                        <button
                            onClick={handleSave}
                            className="px-8 py-3 bg-white text-black hover:bg-neutral-200 rounded-xl text-sm font-black uppercase tracking-widest shadow-lg transition-all flex items-center gap-2"
